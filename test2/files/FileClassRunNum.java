...
public class FileClassRun {
	public static void main(String[] args) throws IOException {
		String path = "C:\\Users\\kosmo\\eclipse-workspace\\javastudy\\src\\study17";
		...
		File file2 = new File("C:\\Users\\kosmo\\eclipse-workspace\\javastudy\\src\\study17\\TestFile.txt");
		File file3 = new File("C:/Users/kosmo/eclipse-workspace/javastudy/src/study17/TestFile.txt");
		File file4 = new File("C:" +File.separator+"Users"+File.separator+
				"kosmo" +File.separator+
				"eclipse-workspace" +File.separator+
				"javastudy" +File.separator+
				"src" +File.separator+
				"study17" +File.separator+"TestFile.txt");
		...
		File file5 = new File("src/study17/TestFile.txt");
		File file6 = new File("src/study17/temp/TestFile.txt");
