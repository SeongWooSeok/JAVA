...
//		}
	...
	public int question1() {
		return Arrays.stream(STRARR).mapToInt(String::length).sum();
	}
	...
	//임의의 로또번호(1~45)(6자리 중복불가)를 정렬 출력
	public String question3() {
		return new Random().ints(1,46).distinct().limit(6).sorted().boxed().collect(Collectors.toList()).toString();
	}
	//두 개의 주사위를 굴려서 나온 눈의 합이 6인경우를 모두 출력
//	public List<Integer> question4() {
//		return IntStream.rangeClosed(1, 6)
//				.boxed().flatMap(i->IntStream.range(1, 6).boxed()
