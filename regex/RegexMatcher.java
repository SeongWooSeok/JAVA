...
public class RegexMatcher {
	public static void main(String[] args) {
		...
		//2)패턴 객체를 matcher메소드로 매처객체로 변환
		Matcher matcher = pattern.matcher(txt);
		//3)정규식 처리 결과를 담은 matcher에서 메소드로 결과를 출력
		System.out.println(matcher.find());
		System.out.println(matcher.group());
		
		String target = "java2023!@#;regex56#$%8080";
...
//		String t2 = "010-4632-1290, 02-8890-7661";
//		String p2 = "(0\\d{1,2})-(\\d{3,4})-(\\d{4)";
//		Matcher m2 = Pattern.compile(p2).matcher(t2);
//		
//		System.out.println("찾은것의 갯수:" + m2.groupCount());
//		
//		int i = 0;
//		while(m2.find()) {
...
//		}
		...
		while(m3.find()) {
			System.out.println("매칭되는 문장열 위치:"
					+m3.start()+"~"+m3.end());
		}
	}
