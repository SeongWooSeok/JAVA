...
public class ArrayCopy {
	public static void main(String[] args) {
			...
			int[] newScores = scores;//얕은복사
			int[] newScores2 = scores.clone();//깊은복사
			...
			//Arrays.compyOf() , Arrays.copyOfRange()
			int[] cal = {1,2,3,4,5,6,7};
			int[] newCal1 = Arrays.copyOf(cal, cal.length);
			...
			int[] newCal4 = Arrays.copyOfRange(cal,3 ,5);
			System.out.println(Arrays.toString(newCal4));
			
			//System.arraycopy()
			int[] arc = {1,2,3,4,5,6};
			int[] newArc1 =new int[6];
			int[] newArc2 =new int[6];
			System.arraycopy(arc, 0, newArc1, 0, 6);
			System.out.println(Arrays.toString(newArc1));
			System.arraycopy(arc, 1, newArc2, 1, 4);
			System.out.println(Arrays.toString(newArc2));
			
			int[] newArc3 = new int[3];
			System.arraycopy(arc, 2, newArc3, 0, 3);
			System.out.println(Arrays.toString(newArc3));
